...
Route_1.default.group(() => {
    ...
    Route_1.default.post('profile/change-username', 'ProfilesController.changeUsername').middleware('auth:api');
    Route_1.default.post('profile/change-password', 'ProfilesController.changePassword').middleware('auth:api');
}).prefix('v1');
