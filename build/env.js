...
exports.default = Env_1.default.rules({
    ...
    NODE_ENV: Env_1.default.schema.enum(['development', 'production', 'staging']),
    SERVER_BASEURL: Env_1.default.schema.string(),
    CLIENT_WEB_BASEURL: Env_1.default.schema.string(),
    ...
    SES_ACCESS_KEY: Env_1.default.schema.string(),
    SES_ACCESS_SECRET: Env_1.default.schema.string(),
    SES_REGION: Env_1.default.schema.string(),
});
